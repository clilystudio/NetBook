...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/alipay/b/d/a;->a:Ljava/util/Map;

    sput-object v0, Lcom/alipay/b/d/a;->b:Ljava/util/Map;

    return-void
.end method

.method private static declared-synchronized a(Ljava/util/Map;)Ljava/lang/String;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-class v4, Lcom/alipay/b/d/a;
...
.method public static declared-synchronized a(Landroid/content/Context;Ljava/util/Map;)Ljava/util/Map;
    ...
    :try_start_0
    sget-object v0, Lcom/alipay/b/d/a;->a:Ljava/util/Map;

    if-nez v0, :cond_0

    invoke-static {p0, p1}, Lcom/alipay/b/d/a;->c(Landroid/content/Context;Ljava/util/Map;)V
...
.method public static declared-synchronized b(Landroid/content/Context;Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/alipay/b/d/a;->a(Ljava/util/Map;)Ljava/lang/String;
...
.method private static declared-synchronized c(Landroid/content/Context;Ljava/util/Map;)V
    ...
    sget-object v0, Lcom/alipay/b/d/a;->b:Ljava/util/Map;

    invoke-static {p0, p1}, Lcom/arcsoft/hpay100/a/a;->a(Landroid/content/Context;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lcom/arcsoft/hpay100/a/a;->g(Landroid/content/Context;)Ljava/util/Map;
    ...
    const-string v4, "AD17"

    const-string v5, ""

    invoke-interface {v3, v4, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v4, "AD18"
    ...
    invoke-static {p0}, Lcom/alipay/security/mobile/module/b/a;->k(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v4, "AD22"

    invoke-virtual {v2, p0}, Lcom/alipay/security/mobile/module/b/a;->n(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/alipay/b/d/a;->b:Ljava/util/Map;

    invoke-interface {v0, v2}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    sget-object v0, Lcom/alipay/b/d/a;->a:Ljava/util/Map;

    invoke-static {p0}, Landroid/support/design/widget/am;->c(Landroid/content/Context;)Ljava/util/Map;
