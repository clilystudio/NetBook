...
.method private initPageView()V
    ...
    iput-object v0, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->flPage:Landroid/widget/FrameLayout;
    ...
    .line 69
    new-instance v0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage$1;

    invoke-virtual {p0}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage$1;-><init>(Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;Landroid/content/Context;)V

    iput-object v0, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->llPage:Landroid/widget/LinearLayout;
    ...
    .line 83
    new-instance v0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;

    invoke-virtual {p0}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->grid:Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;
    ...
    invoke-virtual {v0, v1}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;->setEditPageBackground(Landroid/view/View;)V
    ...
    .line 87
    iget-object v1, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->grid:Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;

    invoke-virtual {v1, v0}, Lcn/sharesdk/onekeyshare/theme/classic/PlatformGridView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v0, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->btnCancel:Landroid/widget/Button;
    ...
    .line 96
    iget-object v1, p0, Lcn/sharesdk/onekeyshare/theme/classic/PlatformListPage;->btnCancel:Landroid/widget/Button;
    ...
    invoke-virtual {v0, v4, v4, v4, v1}, Landroid/widget/Button;->setPadding(IIII)V
    ...
    const-string v1, "classic_platform_corners_bg"
