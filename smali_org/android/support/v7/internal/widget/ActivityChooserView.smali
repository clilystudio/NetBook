...
.field private final c:Landroid/support/v7/internal/widget/w;
...
.field private m:Landroid/support/v7/widget/L;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/internal/widget/s;-><init>(Landroid/support/v7/internal/widget/ActivityChooserView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/w;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/w;
    ...
    invoke-direct {v2, p0, v0}, Landroid/support/v7/internal/widget/t;-><init>(Landroid/support/v7/internal/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    invoke-direct {v0, p0, v4}, Landroid/support/v7/internal/widget/v;-><init>(Landroid/support/v7/internal/widget/ActivityChooserView;B)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    .line 266
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    new-instance v1, Landroid/support/v7/internal/widget/u;

    invoke-direct {v1, p0}, Landroid/support/v7/internal/widget/u;-><init>(Landroid/support/v7/internal/widget/ActivityChooserView;)V

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/v;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActivityChooserView;)Landroid/support/v7/internal/widget/v;
    .locals 1
...
.method private a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->e()Landroid/support/v7/internal/widget/l;
    ...
    .line 357
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v3}, Landroid/support/v7/internal/widget/v;->c()I
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/internal/widget/v;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/internal/widget/v;->a(I)V

    .line 368
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->d()Landroid/support/v7/widget/L;
    ...
    .line 371
    :cond_1
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v2, v1, v0}, Landroid/support/v7/internal/widget/v;->a(ZZ)V

    .line 375
    :goto_3
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->a()I
    ...
    .line 376
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/L;->c(I)V

    .line 377
    invoke-virtual {v3}, Landroid/support/v7/widget/L;->c()V
    ...
    .line 381
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/L;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/internal/widget/v;->a(Z)V

    .line 365
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v3, p1}, Landroid/support/v7/internal/widget/v;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Landroid/support/v7/internal/widget/v;->a(ZZ)V
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActivityChooserView;)Landroid/support/v7/widget/L;
    .locals 1
...
.method static synthetic c(Landroid/support/v7/internal/widget/ActivityChooserView;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->getCount()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->c()I

    move-result v0

    .line 5528
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/v;

    invoke-virtual {v1}, Landroid/support/v7/internal/widget/v;->d()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->b()Landroid/content/pm/ResolveInfo;
...
.method private d()Landroid/support/v7/widget/L;
    .locals 2

    .prologue
    .line 505
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->m:Landroid/support/v7/widget/L;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->m:Landroid/support/v7/widget/L;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/L;->a(Landroid/widget/ListAdapter;)V

    .line 508
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->m:Landroid/support/v7/widget/L;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/L;->a(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/w;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/L;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/L;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public setActivityChooserModel(Landroid/support/v7/internal/widget/l;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/v;->a(Landroid/support/v7/internal/widget/l;)V
