...
.field protected g:Landroid/support/v4/view/ViewPropertyAnimatorCompat;

.field private i:Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/internal/widget/AbsActionBarView;->h:Landroid/view/animation/Interpolator;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->i:Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->a:Landroid/content/Context;
    ...
    .line 72
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->a:Landroid/content/Context;
...
.method public a(I)V
    ...
    .line 134
    iget-object v0, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->g:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    .line 140
    iget-object v0, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->d:Landroid/view/ViewGroup;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->b:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 146
    sget-object v1, Landroid/support/v7/internal/widget/AbsActionBarView;->h:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPropertyAnimatorCompat;->setInterpolator(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ViewPropertyAnimatorCompat;

    .line 147
    iget-object v1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->d:Landroid/view/ViewGroup;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->b:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 149
    iget-object v2, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->b:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 151
    iget-object v3, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->i:Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;

    invoke-virtual {v3, v0, p1}, Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;->a(Landroid/support/v4/view/ViewPropertyAnimatorCompat;I)Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;

    move-result-object v3

    invoke-virtual {v1, v3}, Landroid/support/v7/internal/view/h;->a(Landroid/support/v4/view/ViewPropertyAnimatorListener;)Landroid/support/v7/internal/view/h;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/view/h;->a(Landroid/support/v4/view/ViewPropertyAnimatorCompat;)Landroid/support/v7/internal/view/h;
    ...
    .line 155
    :cond_2
    iget-object v1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->i:Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;

    invoke-virtual {v1, v0, p1}, Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;->a(Landroid/support/v4/view/ViewPropertyAnimatorCompat;I)Landroid/support/v7/internal/widget/AbsActionBarView$VisibilityAnimListener;
...
.method public a()Z
    ...
    .prologue
    .line 177
    iget-object v0, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->c:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method public setContentHeight(I)V
    ...
    .prologue
    .line 111
    iput p1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->f:I
...
.method public setSplitToolbar(Z)V
    ...
    .prologue
    .line 99
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->e:Z
...
.method public setSplitView(Landroid/view/ViewGroup;)V
    ...
    .prologue
    .line 120
    iput-object p1, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->d:Landroid/view/ViewGroup;
