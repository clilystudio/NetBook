...
.method public static initSDK(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    :cond_0
    sget-object v1, Lcn/sharesdk/framework/ShareSDK;->a:Lcn/sharesdk/framework/k;

    if-nez v1, :cond_1

    invoke-virtual {v0, v2}, Lcom/mob/tools/b/a;->a(I)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0}, Lcn/sharesdk/framework/utils/f;->a(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/sharesdk/framework/utils/f;->b(Landroid/content/Context;)I
