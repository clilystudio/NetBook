.class public final Lcom/mob/tools/b/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/mob/tools/b/j;->a:[Ljava/lang/String;
...
.method private static declared-synchronized a()V
    ...
    .prologue
    .line 0
    const-class v1, Lcom/mob/tools/b/j;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/mob/tools/b/j;->b:Landroid/os/Handler;
    ...
    new-instance v3, Lcom/mob/tools/b/k;

    invoke-direct {v3}, Lcom/mob/tools/b/k;-><init>()V

    invoke-direct {v0, v2, v3}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    sput-object v0, Lcom/mob/tools/b/j;->b:Landroid/os/Handler;
    :try_end_0
    ...
    sget-object v2, Lcom/mob/tools/b/j;->a:[Ljava/lang/String;
...
.method static synthetic a(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/mob/tools/b/l;

    iget-object v1, v0, Lcom/mob/tools/b/l;->a:Landroid/os/Message;

    iget-object v0, v0, Lcom/mob/tools/b/l;->b:Landroid/os/Handler$Callback;
...
.method public static a(IJLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {}, Lcom/mob/tools/b/j;->a()V

    sget-object v0, Lcom/mob/tools/b/j;->b:Landroid/os/Handler;

    invoke-static {p0, p3}, Lcom/mob/tools/b/j;->b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(ILandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcom/mob/tools/b/j;->b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(Landroid/os/Message;JLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p3}, Lcom/mob/tools/b/j;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(Landroid/os/Message;Landroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcom/mob/tools/b/j;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method private static b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
    ...
    invoke-static {v0, p1}, Lcom/mob/tools/b/j;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method private static b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
    ...
    new-instance v1, Lcom/mob/tools/b/l;

    invoke-direct {v1, p0, p1}, Lcom/mob/tools/b/l;-><init>(Landroid/os/Message;Landroid/os/Handler$Callback;)V
