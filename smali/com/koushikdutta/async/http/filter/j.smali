.class public Lcom/koushikdutta/async/http/filter/j;
...
.field private b:Lcom/koushikdutta/async/v;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 12
    const-class v0, Lcom/koushikdutta/async/http/filter/j;
    ...
    :goto_0
    sput-boolean v0, Lcom/koushikdutta/async/http/filter/j;->c:Z
...
.method public constructor <init>(Ljava/util/zip/Inflater;)V
    ...
    iput-object v0, p0, Lcom/koushikdutta/async/http/filter/j;->b:Lcom/koushikdutta/async/v;

    .line 65
    iput-object p1, p0, Lcom/koushikdutta/async/http/filter/j;->a:Ljava/util/zip/Inflater;
...
.method public a(Lcom/koushikdutta/async/y;Lcom/koushikdutta/async/v;)V
    ...
    .line 34
    iget-object v3, p0, Lcom/koushikdutta/async/http/filter/j;->a:Ljava/util/zip/Inflater;
    ...
    .line 40
    iget-object v3, p0, Lcom/koushikdutta/async/http/filter/j;->b:Lcom/koushikdutta/async/v;

    invoke-virtual {v3, v0}, Lcom/koushikdutta/async/v;->a(Ljava/nio/ByteBuffer;)V

    .line 41
    sget-boolean v3, Lcom/koushikdutta/async/http/filter/j;->c:Z
    ...
    .line 56
    invoke-virtual {p0, v0}, Lcom/koushikdutta/async/http/filter/j;->a_(Ljava/lang/Exception;)V
    ...
    .line 48
    :cond_3
    invoke-static {v1}, Lcom/koushikdutta/async/v;->c(Ljava/nio/ByteBuffer;)V
    ...
    .line 51
    iget-object v1, p0, Lcom/koushikdutta/async/http/filter/j;->b:Lcom/koushikdutta/async/v;

    invoke-virtual {v1, v0}, Lcom/koushikdutta/async/v;->a(Ljava/nio/ByteBuffer;)V

    .line 53
    iget-object v0, p0, Lcom/koushikdutta/async/http/filter/j;->b:Lcom/koushikdutta/async/v;
...
.method protected final a_(Ljava/lang/Exception;)V
    ...
    .prologue
    .line 17
    iget-object v0, p0, Lcom/koushikdutta/async/http/filter/j;->a:Ljava/util/zip/Inflater;
