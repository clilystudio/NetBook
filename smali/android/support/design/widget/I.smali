...
.method constructor <init>(Landroid/view/View;Landroid/support/design/widget/N;)V
    ...
    .prologue
    .line 45
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/F;-><init>(Landroid/view/View;Landroid/support/design/widget/N;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/I;->j:Landroid/view/animation/Interpolator;
...
.method private a(Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .prologue
    .line 129
    iget-object v0, p0, Landroid/support/design/widget/I;->j:Landroid/view/animation/Interpolator;
...
.method final a(I)V
    ...
    .prologue
    .line 94
    iget-object v0, p0, Landroid/support/design/widget/I;->h:Landroid/graphics/drawable/RippleDrawable;
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 65
    invoke-virtual {p0, p5, p2}, Landroid/support/design/widget/I;->a(ILandroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/design/widget/I;->i:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/I;->h:Landroid/graphics/drawable/RippleDrawable;

    .line 75
    iget-object v0, p0, Landroid/support/design/widget/I;->f:Landroid/support/design/widget/N;

    iget-object v1, p0, Landroid/support/design/widget/I;->h:Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-interface {v0, v4, v4, v4, v4}, Landroid/support/design/widget/N;->a(IIII)V
    ...
    .line 68
    :cond_1
    iput-object v5, p0, Landroid/support/design/widget/I;->i:Landroid/graphics/drawable/Drawable;
...
.method final b(F)V
    ...
    .line 107
    sget-object v1, Landroid/support/design/widget/I;->b:[I

    iget-object v2, p0, Landroid/support/design/widget/I;->e:Landroid/view/View;
    ...
    invoke-direct {p0, v2}, Landroid/support/design/widget/I;->a(Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 112
    sget-object v1, Landroid/support/design/widget/I;->d:[I
    ...
    .line 115
    iget-object v1, p0, Landroid/support/design/widget/I;->e:Landroid/view/View;
...
.method final d()Landroid/support/design/widget/i;
    .locals 1
