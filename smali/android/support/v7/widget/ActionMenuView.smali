...
.method static synthetic b(Landroid/support/v7/widget/ActionMenuView;)Landroid/support/v7/internal/view/menu/h;
    .locals 1

    .prologue
    .line 43
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/internal/view/menu/h;
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/G;
    .locals 1
...
.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/G;
    .locals 1
...
.method public final c()Landroid/view/Menu;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/h;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->g:Landroid/support/v7/internal/view/menu/v;
    ...
    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/internal/view/menu/v;)V
...
.method public final d()Landroid/support/v7/internal/view/menu/MenuBuilder;
    .locals 1
...
.method protected final synthetic j()Landroid/support/v7/widget/G;
    .locals 1
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v7/internal/view/menu/MenuBuilder;->b(Z)V
...
.method public setMenuCallbacks(Landroid/support/v7/internal/view/menu/v;Landroid/support/v7/internal/view/menu/h;)V
    ...
    .prologue
    .line 640
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->g:Landroid/support/v7/internal/view/menu/v;

    .line 641
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/internal/view/menu/h;
