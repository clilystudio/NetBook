...
.method synthetic constructor <init>(Landroid/support/v7/internal/widget/ActivityChooserView;B)V
    ...
    .prologue
    .line 554
    invoke-direct {p0, p1}, Landroid/support/v7/internal/widget/w;-><init>(Landroid/support/v7/internal/widget/ActivityChooserView;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 593
    iget-object v1, p0, Landroid/support/v7/internal/widget/w;->a:Landroid/support/v7/internal/widget/ActivityChooserView;

    invoke-static {v1}, Landroid/support/v7/internal/widget/ActivityChooserView;->a(Landroid/support/v7/internal/widget/ActivityChooserView;)Landroid/support/v7/internal/widget/v;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v7/internal/widget/v;->e()Landroid/support/v7/internal/widget/l;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/l;->a(Landroid/content/pm/ResolveInfo;)I
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/l;->b(I)Landroid/content/Intent;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 560
    invoke-virtual {v0, p3}, Landroid/support/v7/internal/widget/v;->getItemViewType(I)I
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/internal/widget/l;->c(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/v;->f()Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/internal/widget/l;->b(I)Landroid/content/Intent;
