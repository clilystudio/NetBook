...
public class GameDetailActivity extends BaseLoadingActivity
{
  ...
  {
    return new com.clilystudio.netbook.d().a(paramContext, GameDetailActivity.class).a("game_id", paramString).a();
  }

  public static Intent a(Context paramContext, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    return new com.clilystudio.netbook.d().a(paramContext, GameDetailActivity.class).a("game_id", paramString).a("is_micro_game", Boolean.valueOf(paramBoolean1)).a("HAS_PLAYED", Boolean.valueOf(paramBoolean2)).a();
  }
 ...
 * Qualified Name:     com.clilystudio.netbook.ui.game.GameDetailActivity
