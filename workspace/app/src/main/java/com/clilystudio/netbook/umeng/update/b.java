          ...
          catch (Exception localException2)
          {
            try
            {
              ...
              while (true)
              {
                ...
                boolean bool5 = "com.clilystudio.netbook.umeng.update.UpdateDialogActivity".equals(localPackageInfo.activities[i3].name);
                if (bool5)
                  i = 1;
                i3++;
              }
              ...
              while (true)
              {
                ...
                boolean bool4 = "com.clilystudio.netbook.umeng.update.net.DownloadingService".equals(localPackageInfo.services[i2].name);
                if (bool4)
                  i = 1;
                i2++;
              }
 ...
 * Qualified Name:     com.clilystudio.netbook.umeng.update.b
