...
public class FeedSettingActivity extends BaseActivity {
    ...
    static void b(FeedSettingActivity feedSettingActivity, int n) {
        ...
        CommonUtil.putIntPref(feedSettingActivity, "feed_chapter_count", feedSettingActivity.b);
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.b = bundle != null ? bundle.getInt("savedCurrentCount", 50) : CommonUtil.getIntPref(this, "feed_chapter_count", 50);
