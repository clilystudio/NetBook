...
public class CipherUtil {
    ...
    public static String a(String key, String content) {
        try {
            ...
            byte[] arrby3 = CommonUtil.copyBytes(arrby2, 0, 16);
            byte[] arrby4 = CommonUtil.copyBytes(arrby2, 16, arrby2.length);
    ...
    public static String b(String string, String string2) {
        try {
            ...
            byte[] arrby2 = CommonUtil.copyBytes(arrby, 0, 16);
            byte[] arrby3 = CommonUtil.copyBytes(arrby, 16, arrby.length);
