...
final class ab extends e<String, Void, HotCommentRoot> {
    ...
    protected final /* synthetic */ void onPostExecute(Object object) {
        ...
        if (hotCommentRoot != null && hotCommentRoot.getComments() != null && hotCommentRoot.getComments().length > 0) {
            this.a.findViewById(R.id.hot_comment_label).setVisibility(View.VISIBLE);
            this.a.findViewById(R.id.hot_comment_label_line).setVisibility(View.VISIBLE);
            ...
            for (int i = 0; i < arrpostComment.length; ++i) {
                ...
                View view = layoutInflater.inflate(R.layout.list_item_topic_comment, (ViewGroup) this.a, false);
                ((CommentItemView) view.findViewById(R.id.comment_item)).b(postComment, -1);
