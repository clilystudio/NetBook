  ...
  implements k
{
  ...
  public final void a(String paramString)
  {
    ...
    do
      ...
      {
        return;
        i locali = com.clilystudio.netbook.hpay100.config.a.b(paramString);
        if (locali == null)
        {
          HPaySdkActivity.b(this.b);
          HPaySdkActivity.k(this.b).setText("验证码提交失败，请重新输入验证码");
        ...
        try
        {
          ...
          str1 = str3;
          com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "resdes:" + str1);
        ...
        catch (Exception localException)
        {
          ...
          catch (JSONException localJSONException)
          {
            ...
            {
              HPaySdkActivity.b(this.b);
              z localz = com.clilystudio.netbook.hpay100.config.a.a(HPaySdkActivity.h(this.b));
 ...
 * Qualified Name:     com.clilystudio.netbook.hpay100.w
