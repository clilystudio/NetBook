...
public class TabWidgetV2 extends TabWidget {
    ...
    public TabWidgetV2(Context context, AttributeSet attributeSet) {
        ...
        typedArray.recycle();
        int n = CommonUtil.getDisplayMetrics((Activity) context).widthPixels;
        ...
        this.d = CommonUtil.getBoolPref(context, "customer_night_theme", false) ? CommonUtil.getNinePatchBitmap(R.drawable.bg_dark_tab_widget_v3, n2, n3, this.getContext()) : CommonUtil.getNinePatchBitmap(R.drawable.bg_tab_widget_v3, n2, n3, this.getContext());
    ...
    public void setItemCount(Context context, int n) {
        this.a = n;
        int n2 = CommonUtil.getDisplayMetrics((Activity) context).widthPixels;
