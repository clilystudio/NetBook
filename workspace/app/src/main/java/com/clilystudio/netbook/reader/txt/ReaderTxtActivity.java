...
public class ReaderTxtActivity extends FragmentActivity
  implements com.clilystudio.netbook.reader.a, com.clilystudio.netbook.reader.d
{
  ...
  private void n()
  {
    com.clilystudio.netbook.reader.n localn1 = this.b[this.k].j();
    ...
    o localo2 = this.b[1];
    o localo3 = this.b[2];
    com.clilystudio.netbook.reader.n localn2 = localo1.j();
    com.clilystudio.netbook.reader.n localn3 = localo2.j();
    com.clilystudio.netbook.reader.n localn4 = localo3.j();
  ...
  private void o()
  {
    com.clilystudio.netbook.reader.n localn = this.b[this.k].j();
    if (localn != null)
    {
  ...
  private void p()
  {
    ...
    if (localo == null);
    com.clilystudio.netbook.reader.n localn;
    do
    {
      return;
      localn = localo.j();
  ...
  private void q()
  {
    ...
    com.clilystudio.netbook.util.e.a(this, 2131034407);
  }
  ...
  private void x()
  {
    com.clilystudio.netbook.reader.n localn = w();
    if (localn == null)
      return;
    if (localn.e())
    {
  ...
  public void onBackPressed()
  {
    ...
    if (localo != null)
    {
      com.clilystudio.netbook.reader.n localn = localo.j();
      if (localn == null)
        return;
    ...
    com.clilystudio.netbook.event.i.a().c(new A());
  }
 ...
 * Qualified Name:     com.clilystudio.netbook.reader.txt.ReaderTxtActivity
