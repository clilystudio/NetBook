    ...
    public final void a(ay paramay, int paramInt) {
        ...
        if ((paramInt == 0) && (this.a)) {
            ...
            if (UGCMainActivity.j(localan.k.c).equals(str2)) {
                localan.i.setTextColor(com.clilystudio.netbook.am.a(localan.k.c, 2130771972));
                localan.i.setBackgroundResource(com.clilystudio.netbook.am.b(localan.k.c, 2130771998));
            }
        }
        label412:
        while (true) {
            return;
            localan.i.setTextColor(com.clilystudio.netbook.am.a(localan.k.c, 16842808));
            localan.i.setBackgroundResource(com.clilystudio.netbook.am.b(localan.k.c, 2130771974));
            return;
