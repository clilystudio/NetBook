...
public final class l
{
  ...
  public static void a(Context paramContext)
  {
    ...
    try
    {
      ...
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "HPAY_NEXT_INITTIME 1:" + i);
      String str = f(localContext.getApplicationContext());
      j = a.b.getString(str, "");
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "hpay_game_init_phone:" + j);
    ...
    catch (Exception localException)
    {
      ...
      l2 = 1000L * i;
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "nextinitTime:" + l2);
    ...
    {
      long l5 = l3 - l1;
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "intervalTime:" + l5);
      if (l5 < l2)
      {
        com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "初始化请求间隔时间太短");
        return;
      }
  ...
  {
    if ((!b.b(paramContext)) || (!com.clilystudio.netbook.hpay100.a_Pack.a.k(paramContext)))
    {
      paramk.a("");
      return;
    }
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "getCMWhite01");
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    do
      return;
    while (com.clilystudio.netbook.hpay100.a_Pack.a.i(paramContext.getApplicationContext()) == -1);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    {
      return;
      i1 = com.clilystudio.netbook.hpay100.a_Pack.a.i(paramContext.getApplicationContext());
    }
    while ((i1 == -1) || (i1 == 6));
  ...
  public static String f(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(str2))
      str1 = str1 + str2;
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "initphonekey:" + str1);
    return str1;
  }
  ...
  private static long g(Context paramContext)
  {
    ...
    try
    {
      ...
      l1 = l2;
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "initRequestTime:" + l1);
      return l1;
    }
    catch (Exception localException)
    {
 ...
 * Qualified Name:     com.clilystudio.netbook.hpay100.config.l
