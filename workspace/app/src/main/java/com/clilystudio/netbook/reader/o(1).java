...
public final class o {
    ...
    private static boolean o() {
        ...
        do
            return false;
        while (!a.a(MyApplication.a(), "auto_buy_chapter" + com.clilystudio.netbook.util.I.a, false));
        return true;
    }
    ...
    private void a(View paramView, Advert paramAdvert) {
        ...
        while (true) {
            ...
            com.clilystudio.netbook.util.adutil.n.a(paramAdvert, paramView);
            return;
        ...
        if (paramBoolean) {
            ...
            if (am.g()) {
                ...
                if ((arrayOfChapterLink == null) || (arrayOfChapterLink.length == 0)) {
                    ...
                    localCheckBox.setChecked(a.a(this.b, "auto_buy_chapter" + com.clilystudio.netbook.util.I.a, false));
    ...
    private void r() {
        ...
        do {
            ...
            if ((am.q(this.b)) && (a.F(this.b)) && (q()) && (a(localView)) && ((this.b instanceof ReaderActivity))) {
                Advert localAdvert = com.clilystudio.netbook.util.adutil.n.b(this.b, "page");
        ...
        while ((!this.e) || (a.a(this.b, "remove_ad_toast_showed" + com.clilystudio.netbook.util.I.a, false)) || (!q()) || (!a(localView)) || (am.r(this.b)));
        e.a(this.b, "已为您自动免除广告");
        a.b(this.b, "remove_ad_toast_showed" + com.clilystudio.netbook.util.I.a, true);
    }
    ...
    @l
    public final void onHideAdEvent(com.clilystudio.netbook.event.s params) {
        s();
    }

    @l
    public final void onLoginEvent(com.clilystudio.netbook.event.t paramt) {
        if (this.e) {
    ...
    @l
    public final void onPayFinish(com.clilystudio.netbook.event.y paramy) {
        if ((this.e) && (paramy.a())) {
    ...
    @l
    public final void onShowThirdAd(com.clilystudio.netbook.event.B paramB) {
    ...
    @l
    public final void onThemeChanged(com.clilystudio.netbook.event.C paramC) {
        r();
    }
}
