...
public final class ReaderStyle {
    ...
    public ReaderStyle(Activity activity) {
        ...
        this.a(CommonUtil.getBoolPref(this.m, "reader_opt_full_screen",true));
        this.k();
        this.c(this.z);
    }
     ...
     */
    private void p() {
        CommonUtil.putBoolPref(this.m, "customer_night_theme", this.x);
        CommonUtil.putBoolPref(this.m, "night_mode", this.x);
        if (this.x) {
            CommonUtil.putLongPref(this.m, "start_night_theme", new Date().getTime());
        } else {
    ...
    public final void a(boolean bl) {
        ...
        if (this.t.getBoolean("key_enable_imersive_mode", false)) {
            ...
            n = CommonUtil.getWindowHeight(this.m);
        }
