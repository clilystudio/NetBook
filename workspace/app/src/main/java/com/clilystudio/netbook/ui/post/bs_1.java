...
final class bs extends c {

    private GirlTopicActivity a;

    public bs(GirlTopicActivity GirlTopicActivity1, Activity Activity2, int int3) {
    ...
    public final void a(Object Object1) {
        ...
        if (VoteResult2 != null) {
            if (VoteResult2.isOk()) {
                GirlTopicActivity.a(a, GirlTopicActivity.j(a), false);
                e.a((Activity) a, "\u6210\u529F");
                VoteRecord.create(GirlTopicActivity.i(a).getUser().getId(), GirlTopicActivity.a(a).get_id(), GirlTopicActivity.j(a));
            } else if ("ALREADY_VOTED".equals(VoteResult2.getCode())) {
                int int4 = VoteResult2.getSelected();

                GirlTopicActivity.a(a, int4, false);
                VoteRecord.create(GirlTopicActivity.i(a).getUser().getId(), GirlTopicActivity.a(a).get_id(), int4);
