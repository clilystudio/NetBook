...
public class UGCGuideAddBookActivity extends BaseActivity
    ...
    public final class SearchPromptAdapter extends BaseAdapter
        ...
        public SearchPromptAdapter(UGCGuideAddBookActivity paramUGCGuideAddBookActivity) {
        }
        ...
        class ViewHolder {
            ...
            ViewHolder(UGCGuideAddBookActivity.SearchPromptAdapter paramSearchPromptAdapter, View paramView) {
