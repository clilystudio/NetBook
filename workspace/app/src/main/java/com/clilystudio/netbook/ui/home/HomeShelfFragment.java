...
import com.clilystudio.netbook.util.adutil.k;
  ...
  implements AbsListView.OnScrollListener
{
  ...
  private void c(List<BookShelf> paramList, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      label17: Advert localAdvert = com.clilystudio.netbook.util.c.a().a(str1);
...
//       if-nez v7, :cond_4
    ...
    v0 = invoke-static {}, com.clilystudio.netbook.db/BookReadRecord;->getAllWithTopNoFeed()Ljava/util/List;
    v1 = v0;
    :goto_0
    v8 = invoke-static {}, com.clilystudio.netbook.db/BookReadRecord;->getAllFeeding()Ljava/util/List;
    v0 = v8.isEmpty();
    if (v0 != 0) {
//       if-nez v0, :cond_5
    }
...
//       if-eqz v11, :cond_3
    ...
    goto :goto_2
    :cond_4
    v0 = invoke-static {}, com.clilystudio.netbook.db/BookReadRecord;->getAllWithTopNoFeedByRead()Ljava/util/List;
    v1 = v0;
    goto :goto_0
    :cond_5
    v0 = 0x0;
...
//       if-eqz v0, :cond_8
    ...
    v2 = v0;
    :goto_3
    v0 = invoke-static {}, com.clilystudio.netbook.db/AudioRecord;->findAll()Ljava/util/List;
    v3 = v0.iterator();
    :goto_4
    v0 = v3.hasNext();
    if (v0 == 0) {
 ...
 * Qualified Name:     com.clilystudio.netbook.ui.home.HomeShelfFragment
