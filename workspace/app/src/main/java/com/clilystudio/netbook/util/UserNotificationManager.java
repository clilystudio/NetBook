                ...
                protected void onPostExecute(NotifCountRoot notifCountRoot) {
                    ...
                    if (notifCountRoot != null && notifCountRoot.isOk()) {
                        ...
                        if (CommonUtil.getImportNofityTime(UserNotificationManager.this.mContext).equals("0")) {
                            TempUtil.e(UserNotificationManager.this.mContext, "pref_new_imp_notif_time", String.valueOf(date.getTime()));
                        }
                        if (CommonUtil.getUnimportNofityTime(UserNotificationManager.this.mContext).equals("0")) {
                            TempUtil.e(UserNotificationManager.this.mContext, "pref_new_unimp_notif_time", String.valueOf(date2.getTime()));
                       }
            ...
            new BaseAsyncTask<String, Void, Root>() {
                ...
                protected void onPostExecute(Root root) {
                    ...
                    if (root != null && root.isOk()) {
                        ...
                        BusProvider.getInstance().post(new NotifEvent());
                        TempUtil.e(UserNotificationManager.this.mContext, "pref_new_imp_notif_time", String.valueOf(System.currentTimeMillis()));
                    }
                }
            }.b(account.getToken());
        }
            ...
            new BaseAsyncTask<String, Void, Root>() {
                ...
                protected void onPostExecute(Root root) {
                    ...
                    if (root != null && root.isOk()) {
                        ...
                        TempUtil.e(UserNotificationManager.this.mContext, "pref_new_unimp_notif_time", String.valueOf(System.currentTimeMillis()));
                        Account account = CommonUtil.getAccount();
