        ...
        this.mReader.a(n2, new OnPageTransListener<ReaderChapter>(){
            ...
            public void onPageTrans(ReaderChapter readerChapter) {
                if (readerChapter.getStatus() != 1) {
                    e2.onPageTrans(ReaderLineInfo.a(ReaderPageTransformer.this, readerChapter, n4));
                    return;
                }
                ...
                e2.onPageTrans(new ReaderLineInfo(ReaderPageTransformer.this, readerChapter, lineStarts, n3));
            }
        }, false, bl);
    }
