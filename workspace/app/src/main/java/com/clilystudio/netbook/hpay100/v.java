...
final class v implements com.clilystudio.netbook.hpay100.config.k {

    private int a;
    private HPaySdkActivity b;
    public v(HPaySdkActivity HPaySdkActivity1, int int2) {
        b = HPaySdkActivity1;
        a = 0;
        a = 4;
    }
            ...
            if (JSONObject2 == null) {
                ...
                if (int3 != 0) {
                    if (!android.text.TextUtils.isEmpty((CharSequence) Object4))
                        HPaySdkActivity.k(b).setText((CharSequence) Object4);
                    else
                        HPaySdkActivity.k(b).setText((CharSequence) "\u83B7\u53D6\u9A8C\u8BC1\u7801\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5");
                    HPaySdkActivity.a(b, HPaySdkActivity.l(b), false);
