  ...
  implements Runnable
{
  ...
  public final void run()
  {
    try
    {
      ...
      com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "data:" + str1);
      HashMap localHashMap = new HashMap();
      localHashMap.put("p", f.a(str1, "dbbsRYnaQPKia/sCWJGRNAsQH7PLIw3a"));
      String str2 = com.clilystudio.netbook.hpay100.a_Pack.a.b(this.a.getApplicationContext(), "http://fee.arc-soft.com:26000/gamefee/sdk/init", localHashMap);
      if (!TextUtils.isEmpty(str2))
      {
        ...
        if (localJSONObject.optInt("status", -1) == 0)
        {
          ...
          if (!TextUtils.isEmpty(str3))
          {
            ...
            com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "resdes:" + str4);
 ...
 * Qualified Name:     com.clilystudio.netbook.hpay100.config.m
