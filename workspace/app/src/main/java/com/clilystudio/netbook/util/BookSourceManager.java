...
public final class BookSourceManager {
    ...
    private void a(int readMode) {
        ...
        if (readMode == 9) {
            ...
            if (CommonUtil.getAccount() != null) {
                HashMap<String, String> hashMap = CommonUtil.loadObject(CachePathConst.ChapterKey, this.mBookId);
                if (hashMap == null) {
                    hashMap = new HashMap<>();
                }
        ...
        String string = CommonUtil.getSourceName(readMode);
        ...
        String string3 = CommonUtil.getMixTocId(this.mBookId, readMode, string2, null);
        if (CommonUtil.getBoolPref(this.mActivity, string, false)) {
            ...
            public void a(TocSourceRoot tocSourceRoot) {
                if (tocSourceRoot != tocSourceRoot && tocSourceRoot.getSources() != null) {
                    ...
                    for (TocSource tocSource : arrtocSource) {
                        CommonUtil.saveSourceRecord(tocSource, BookSourceManager.this.mBookId);
    ...
    public final void a(BookReadRecord p1) {
        ...
        if (p1.have_cp == 1) {
            ...
            int var5_5 = CommonUtil.getIntPref(this.mActivity, "PREF_FIRST_LAUNCH_TIME", 0);
