...
public class ReaderRandomActivity extends FragmentActivity
{
  ...
  {
    return new com.clilystudio.netbook.d().a(paramContext, ReaderRandomActivity.class).a("BOOK_ID", paramString1).a("BOOK_TITLE", paramString2).a("TOC_ID", paramString3).a();
  }
  ...
  private void c()
  {
    ...
    com.clilystudio.netbook.reader.o localo1 = this.a[0];
    com.clilystudio.netbook.reader.o localo2 = this.a[1];
    com.clilystudio.netbook.reader.o localo3 = this.a[2];
    n localn2 = localo1.j();
    n localn3 = localo2.j();
    n localn4 = localo3.j();
  ...
  private void e()
  {
    com.clilystudio.netbook.reader.o localo = this.a[this.k];
    if (localo == null);
    n localn;
    do
    {
 ...
 * Qualified Name:     com.clilystudio.netbook.reader.random.ReaderRandomActivity
