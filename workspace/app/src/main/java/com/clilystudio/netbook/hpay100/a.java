...
public final class a
{
  ...
  {
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "startHPaySdk-------");
    if (!a)
    {
      c.a(paramActivity, "请初始化支付sdk", 1);
      com.clilystudio.netbook.hpay100.config.a.a(paramActivity.getApplicationContext(), paramString1, paramString2, paramInt2, -1, "2", "2001", 0);
      return;
    }
    if (TextUtils.isEmpty(paramString2))
    {
      c.a(paramActivity, "计费点编号不能为空", 1);
      com.clilystudio.netbook.hpay100.config.a.a(paramActivity.getApplicationContext(), paramString1, paramString2, paramInt2, -1, "2", "2003", 0);
      return;
    }
    if (paramInt2 <= 0)
    {
      c.a(paramActivity, "计费金额传入错误", 1);
      com.clilystudio.netbook.hpay100.config.a.a(paramActivity.getApplicationContext(), paramString1, paramString2, paramInt2, -1, "2", "2004", 0);
      return;
    }
    if (TextUtils.isEmpty(paramString3))
    {
      c.a(paramActivity, "计费点名称不能为空", 1);
      com.clilystudio.netbook.hpay100.config.a.a(paramActivity.getApplicationContext(), paramString1, paramString2, paramInt2, -1, "2", "2005", 0);
      return;
    }
    if (!com.clilystudio.netbook.hpay100.a_Pack.a.j(paramActivity))
    {
  ...
  {
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "initHPaySdk ----");
    ...
    while (a);
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "initHPaySdk activity start-----");
    a = true;
    ...
    com.clilystudio.netbook.hpay100.c.b.d(paramActivity.getApplicationContext());
    MiguSdk.initializeApp(paramActivity);
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "initMgdmSdk");
    com.clilystudio.netbook.hpay100.config.a.a(paramActivity.getApplicationContext(), "1", "", 0);
    long l2 = System.currentTimeMillis();
    com.clilystudio.netbook.hpay100.a_Pack.a.b("dalongTest", "time2-time1:" + (l2 - l1));
  }
 ...
 * Qualified Name:     com.clilystudio.netbook.hpay100.a
