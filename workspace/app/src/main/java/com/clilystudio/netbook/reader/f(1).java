...
public final class f
{
  ...
  private Toc a(com.clilystudio.netbook.model.ChapterLink[] paramArrayOfChapterLink)
  {
  ...
  private List<com.clilystudio.netbook.model.ChapterLink> a(int paramInt1, int paramInt2)
  {
    com.clilystudio.netbook.model.ChapterLink[][] arrayOfChapterLink; = new com.clilystudio.netbook.model.ChapterLink[paramInt2][];
    ...
    for (int k = 0; ; k++)
    {
      [Lcom.clilystudio.netbook.model.ChapterLink localChapterLink;;
      int m;
      if (k < j)
      {
  ...
  private Toc d()
  {
    ...
    catch (Exception localException)
    {
      ...
      while (true)
      {
        ...
        if (k <= 0)
          break;
        return a((com.clilystudio.netbook.model.ChapterLink[])localList.toArray(new com.clilystudio.netbook.model.ChapterLink[k]));
        if (i <= 200)
        {
          j = 1;
          continue;
  ...
  private Toc e()
  {
      ...
      if (localSgTocRoot1 != null)
      {
        ...
        if (arrayOfSgTocChapter1 != null)
        {
          ...
          if (localSgTocBook != null)
          {
            ...
            arrayOfChapterLink = new com.clilystudio.netbook.model.ChapterLink[i];
            for (int j = 0; j < i; j++)
            {
              SgTocChapter localSgTocChapter = arrayOfSgTocChapter2[j];
              if (localSgTocChapter == null)
                continue;
              arrayOfChapterLink[j] = new com.clilystudio.netbook.model.ChapterLink();
    ...
    {
      int i;
      com.clilystudio.netbook.model.ChapterLink[] arrayOfChapterLink;
      while (true)
      {
        localException.printStackTrace();
  ...
  public final ChapterRoot a(com.clilystudio.netbook.model.ChapterLink paramChapterLink, int paramInt)
  {
    if (this.e == null)
      this.e = I.d;
    if (this.f == null)
 ...
 * Qualified Name:     com.clilystudio.netbook.reader.f
