...
final class aX extends e_BaseAsyncTask<String, Void, List<BookSummary>> {
    private aX(BookTagListActivity paramBookTagListActivity) {
    }

    private List<BookSummary> a() {
        try {
            BookTagRoot localBookTagRoot = b.b().c(BookTagListActivity.b_initContentView(this.a), 0, 50);
 ...
 * Qualified Name:     com.clilystudio.app.netbook.ui.aX
