...
import com.clilystudio.app.netbook.model.mixtoc.EsTocItem;
import com.clilystudio.app.netbook.model.mixtoc.EsTocRoot;
import com.clilystudio.app.netbook.model.mixtoc.LdTocResult;
import com.clilystudio.app.netbook.model.mixtoc.LdTocRoot;
import com.clilystudio.app.netbook.model.mixtoc.SgTocBook;
import com.clilystudio.app.netbook.model.mixtoc.SgTocChapter;
...
public final class f
{
  ...
  private Toc a(com.clilystudio.app.netbook.model.ChapterLink[] paramArrayOfChapterLink)
  {
  ...
  private List<com.clilystudio.app.netbook.model.ChapterLink> a(int paramInt1, int paramInt2)
  {
    com.clilystudio.app.netbook.model.ChapterLink[][] arrayOfChapterLink; = new com.clilystudio.app.netbook.model.ChapterLink[paramInt2][];
    ...
    for (int k = 0; ; k++)
    {
      [Lcom.clilystudio.app.netbook.model.ChapterLink localChapterLink;;
      int m;
      if (k < j)
      {
  ...
  private Toc d()
  {
    ...
    catch (Exception localException)
    {
      ...
      while (true)
      {
        ...
        if (k <= 0)
          break;
        return a((com.clilystudio.app.netbook.model.ChapterLink[])localList.toArray(new com.clilystudio.app.netbook.model.ChapterLink[k]));
        if (i <= 200)
        {
          j = 1;
        }
  ...
  private Toc e()
  {
      ...
      if (localSgTocRoot1 != null)
      {
        ...
        if (arrayOfSgTocChapter1 != null)
        {
          ...
          if (localSgTocBook != null)
          {
            ...
            arrayOfChapterLink = new com.clilystudio.app.netbook.model.ChapterLink[i];
            for (int j = 0; j < i; j++)
            {
              SgTocChapter localSgTocChapter = arrayOfSgTocChapter2[j];
              if (localSgTocChapter != null)
              {
                arrayOfChapterLink[j] = new com.clilystudio.app.netbook.model.ChapterLink();
    ...
    {
      int i;
      com.clilystudio.app.netbook.model.ChapterLink[] arrayOfChapterLink;
      while (true)
      {
        localException.printStackTrace();
  ...
  public final ChapterRoot a(com.clilystudio.app.netbook.model.ChapterLink paramChapterLink, int paramInt)
  {
    if (this.e == null)
      this.e = I.d;
    if (this.f == null)
 ...
 * Qualified Name:     com.clilystudio.app.netbook.reader.f
