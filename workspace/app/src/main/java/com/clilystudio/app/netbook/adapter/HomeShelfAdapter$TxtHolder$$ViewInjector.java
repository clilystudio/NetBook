...
public class HomeShelfAdapter$TxtHolder$$ViewInjector {
    public static void inject(ButterKnife.Finder paramFinder, HomeShelfAdapter.TxtHolder paramTxtHolder, Object paramObject) {
        paramTxtHolder.title = ((TextView) paramFinder.findRequiredView(paramObject, R.id.title, "field 'title'"));
 ...
 * Qualified Name:     com.clilystudio.app.netbook.adapter.HomeShelfAdapter.TxtHolder..ViewInjector
