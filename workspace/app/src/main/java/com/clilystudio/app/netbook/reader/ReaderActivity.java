...
import com.clilystudio.app.netbook.db.MixTocRecord;
  ...
  implements View.OnClickListener, a, d
{
  ...
  private void Q()
  {
    if (com.arcsoft.hpay100.a.a.d())
    {
      ...
      {
        String str = am_CommonUtils.1(String)localIterator.next());
        this.x.add(str);
      }
    }
  }
  ...
  private void R()
  {
    ...
    if (this.h.g());
    for (float f1 = -1.0F; ; f1 = this.h.f() / 255.0F)
    {
  ...
  {
    boolean bool1 = paramae.a(paramString, this.g.c(paramInt));
    boolean bool2 = false;
    if (bool1)
    {
      this.g.a(paramInt);
  ...
  private void v()
  {
    ...
    if ((localn1 != null) && (!localn1.p()))
      if (localn1.n() == 1)
        c(localn1.l());
    n localn3;
    label304: Object[] arrayOfObject1;
    do
    {
      do
      {
      ...
      if (this.aa.size() != 0)
        break;
      arrayOfObject1 = localn3.d();
    }
    while (arrayOfObject1 == null);
  ...
  public final void i()
  {
    ...
    {
      com.clilystudio.app.netbook.util.I.d = str;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      com.clilystudio.app.netbook.util.I.a = this.c;
      com.clilystudio.app.netbook.util.I.b = this.d;
      com.clilystudio.app.netbook.util.I.d = this.f;
      com.clilystudio.app.netbook.util.I.c = this.e;
      com.clilystudio.app.netbook.util.I.g = this.L;
      ...
      try
      {
        ...
        if (this.h.h == 2130838077)
        {
          ...
          if (am_CommonUtils.e() != null)
          {
            ...
            arrayOfString2[0] = am_CommonUtils.e().getToken();
  ...
  public void onResume()
  {
    ...
    K();
    LocalBroadcastManager.getInstance(this).registerReceiver(this.ae, new IntentFilter("com.clilystudio.app.netbook.dlReceiver"));
    H();
 ...
 * Qualified Name:     com.clilystudio.app.netbook.reader.ReaderActivity
