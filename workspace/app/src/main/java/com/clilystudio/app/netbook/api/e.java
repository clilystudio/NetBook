...
import com.clilystudio.app.netbook.exception.DnsParseFailedException;
...
public final class e {
    ...
    public static void a(HttpRequest paramHttpRequest) {
        ...
        b.a(locald, str1);
        label223:
        paramHttpRequest.a(new URL(localURL.toString().replace(str1, str2)));
 ...
 * Qualified Name:     com.clilystudio.app.netbook.api.e
