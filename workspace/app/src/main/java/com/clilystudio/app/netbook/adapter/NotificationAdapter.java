...
import com.clilystudio.app.netbook.viewbinder.notification.NotifBinder;
import com.clilystudio.app.netbook.viewbinder.notification.NotifBinderFactory;
import com.clilystudio.app.netbook.widget.DividerSection;
...
public abstract class NotificationAdapter extends u<NotificationItem> {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        ...
        label266:
        label303:
        for (View localView = LayoutInflater.from(this.b).inflate(2130903292, paramViewGroup, false); ; localView = paramView) {
 ...
 * Qualified Name:     com.clilystudio.app.netbook.adapter.NotificationAdapter
