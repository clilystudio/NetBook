...
public class ReaderViewPager extends ViewGroup {
    ...
    private static final Comparator<cs> COMPARATOR = new co();
            ...
            if (i3 < i2) {
                ...
                switch (0x7 & localct.b) {
                    ...
                    default:
                        ...
                        i6 = i14;
                        label132:
                        int i10 = i8 + k - localView2.getLeft();
                        if (i10 != 0)
    ...
    private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        if (localcs1 != null) ;
        for (float f = Math.min(localcs1.e, this.mLastOffset); ; f = 0.0F) {
            ...
            if (i19 < localcs4.b) {
                ...
                while (true) {
                    ...
                    if (i13 > localcs3.b) {
                        ...
                        label625:
                        float f5 = f1 + (paramcs1.e + paramcs1.d);
                        int i1 = 1 + paramcs1.b;
                        int i3;
            ...
            while (true) {
                ...
                for (cs localcs3 = a(this.mCurItem, i1); ; localcs3 = localcs2) {
                    ...
                    while (true) {
                        ...
                        break label786;
                        label828:
                        if ((localObject2 != null) && (i12 == ((cs) localObject2).b)) {
    ...
    protected void onDraw(Canvas paramCanvas) {
        ...
        if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null)) {
            ...
            if (i2 < n) {
                ...
                float f3;
                for (f2 = f1 + (localcs.e + localcs.d); ; f2 += f3 + f1) {
    ...
    public void setAdapter(PagerAdapter paramPagerAdapter) {
        ...
        if (this.mAdapter != null) {
            if (this.mObserver == null)
                this.mObserver = new cx(this, (byte) 0);
    ...
    public void setPageTransformer$7c662580(boolean paramBoolean, K paramK) {
        ...
        while (true) {
            ...
            if (this.mPageTransformer$572aa01b != null) {
                ...
                i1 = i;
                label37:
                this.mPageTransformer$572aa01b = paramK;
 ...
 * Qualified Name:     com.clilystudio.app.netbook.reader.ReaderViewPager
