...
final class I_BookRecommandTask extends c<String, BookGenderRecommend> {
    public I_BookRecommandTask(HomeShelfFragment paramHomeShelfFragment, Activity paramActivity) {
