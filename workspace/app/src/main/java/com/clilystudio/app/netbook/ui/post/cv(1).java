...
final class cv extends e_BaseAsyncTask<String, Void, PostDetailComment> {
    private cv(PostDetailActivity paramPostDetailActivity) {
    }

    private PostDetailComment a(String[] paramArrayOfString) {
        try {
            PostDetailComment localPostDetailComment = b.b().e(paramArrayOfString[0], PostDetailActivity.c_initContentView(this.a).getCount(), 30);
