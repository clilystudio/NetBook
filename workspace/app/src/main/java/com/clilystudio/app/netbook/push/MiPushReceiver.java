package com.clilystudio.app.netbook.push;

import android.content.Context;
import android.text.TextUtils;
import com.clilystudio.app.netbook.util.InsideLinkIntent;
import com.clilystudio.app.netbook.util.a.b;
...
public class MiPushReceiver extends PushMessageReceiver
{
  ...
  public final void a(MiPushCommandMessage paramMiPushCommandMessage)
  {
    ...
    while (true)
    {
      label52: long l = paramMiPushCommandMessage.getResultCode();
      if ((str2 != null) && (l == 0L))
      ...
      label145: System.out.println("PUSH UN SUB ERROR: " + l);
      return;
      label169: str2 = null;
      str3 = null;
    }
 ...
 * Qualified Name:     com.clilystudio.app.netbook.push.MiPushReceiver
