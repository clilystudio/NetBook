...
public class HomeShelfAdapter extends u<BookShelf>
{
  ...
  private void a(int paramInt, CheckBox paramCheckBox)
  {
    ...
    label76: paramCheckBox.setChecked(this.f[paramInt]);
    b(paramInt);
    this.g = false;
  ...
  private void b(int paramInt)
  {
    ...
    while (true)
    {
      ...
      break;
      label133: this.h.setText("删除");
    }
    label145: this.i.setText("全选");
  }
      ...
      do
      {
        ...
        case 3:
          ...
          while (true)
          {
            ...
            else if (!localBookHolder.coverLoadingLayer.g())
              localBookHolder.coverLoadingLayer.c();
          }
        }
      }
 ...
 * Qualified Name:     com.clilystudio.app.netbook.adapter.HomeShelfAdapter
