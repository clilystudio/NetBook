...
public class TabWidgetV2 extends TabWidget {
    ...
    public TabWidgetV2(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        int i = am_CommonUtils.1(Activity) paramContext).widthPixels;
        int j = (int) (2.1D * i);
        this.b = (i / this.a);
        this.g = (-(j - i) / 2);
        ...
        for (this.d = am_CommonUtils.12130837642, j, k, getContext()); ; this.d = am_CommonUtils.12130837694, j, k, getContext())) {
