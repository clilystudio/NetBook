...
final class L
    ...
    public final void onClick(DialogInterface paramDialogInterface, int paramInt) {
        ...
        String str1 = AddVoteActivity.a_initContentView(this.b).getText().toString().trim();
        String str2 = AddVoteActivity.b_initContentView(this.b).getText().toString().trim();
        P localP = new P(this.b, this.b, 2131034430);
        String[] arrayOfString = new String[4];
        arrayOfString[0] = this.a;
        arrayOfString[1] = AddVoteActivity.c_initContentView(this.b);
