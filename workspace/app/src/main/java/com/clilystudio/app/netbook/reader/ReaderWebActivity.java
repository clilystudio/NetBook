...
public class ReaderWebActivity extends BaseReadActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    label388: label692: for (int i = localSourceWebReadRecord.getChapterIndex(); ; i = 0)
    {
      String str1;
      cC localcC;
      switch (this.b)
      ...
      for (String str2 = localSourceWebReadRecord.getCmd(); ; str2 = null)
      {
        ...
        break;
        label630: cD localcD = new cD(this);
        h localh = new h(this);
        localh.e = str1;
 ...
 * Qualified Name:     com.clilystudio.app.netbook.reader.ReaderWebActivity
