...
import com.clilystudio.app.netbook.event.q;
...
public class MyTweetFragment extends Fragment
{
  ...
  private void a()
  {
    ...
    while (true)
    {
      ...
      return;
      label265: if (localUser.isOfficial())
      {
        this.h.setVisibility(0);
  ...
  private void a(TweetsResult paramTweetsResult)
  {
    ...
    if (arrayOfTweet.length > 0)
    {
      ...
      for (int i2 = 0; i2 < i1; i2++)
      {
        ...
        localTweet.setUser(am_CommonUtils.e().getUser());
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    if (am_CommonUtils.e() != null)
    {
      List localList = TweetCache.find(am_CommonUtils.e().getUser().getId(), 3);
 ...
 * Qualified Name:     com.clilystudio.app.netbook.ui.post.MyTweetFragment
