...
final class ag extends BaseAdapter
{
  ...
  public ag(PayVoucherFragment paramPayVoucherFragment, LayoutInflater paramLayoutInflater)
  {
    ...
    default:
      return;
    case 0:
      this.c = am_CommonUtils.b_getBackgroundResourceId(paramPayVoucherFragment.getActivity(), 2130772009);
      this.d = 2131427467;
      this.e = "可\n使\n用";
      return;
    case 1:
      this.c = am_CommonUtils.b_getBackgroundResourceId(paramPayVoucherFragment.getActivity(), 2130772008);
      this.d = 2131427466;
      this.e = "已\n用\n完";
      return;
    case 2:
