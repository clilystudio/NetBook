...
import com.clilystudio.app.netbook.model.Tweet.VoteOption;
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    if (i4 < 7)
    {
      ...
      if (i4 == paramInt)
      {
        ...
        label184: if ((i1 == 0) || (i4 >= i2))
          break label329;
        arrayOfFloat[i4] = (arrayOfInt[i4] / i1);
      }
      while (true)
      {
 ...
 * Qualified Name:     com.clilystudio.app.netbook.ui.post.TweetDetailActivity
