...
public final class SplashAD
{
  ...
  public SplashAD(Activity paramActivity, ViewGroup paramViewGroup, String paramString1, String paramString2, SplashADListener paramSplashADListener)
  {
    ...
    if (!com.qq.e.comm.a.a(paramActivity))
    {
    ...
    catch (com.qq.e.comm.managers.plugin.a locala)
    {
      GDTLogger.e("Fail to init splash plugin", locala);
      ...
      if (this.a != null)
      {
        this.a.setAdListener(new SplashAD.ADListenerAdapter(this, 0));
    ...
    {
      GDTLogger.e("Unknown Exception", localThrowable);
