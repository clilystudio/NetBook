  ...
  implements NetworkClient
{
  ...
  {
    NetworkClientImpl.NetFutureTask localNetFutureTask = new NetworkClientImpl.NetFutureTask(this, new NetworkClientImpl.TaskCallable(paramRequest), paramPriority);
    this.c.execute(localNetFutureTask);
    GDTLogger.d("QueueSize:" + this.d.size());
    return localNetFutureTask;
  }
  ...
  {
    NetworkClientImpl.NetFutureTask localNetFutureTask = new NetworkClientImpl.NetFutureTask(this, new NetworkClientImpl.TaskCallable(paramRequest, paramNetworkCallBack), paramPriority);
    this.c.execute(localNetFutureTask);
    GDTLogger.d("QueueSize:" + this.d.size());
  }
}
