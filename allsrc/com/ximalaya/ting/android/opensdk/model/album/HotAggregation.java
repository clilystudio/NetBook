...
public class HotAggregation
{
  ...
  {
    return "HotAggregation [totalPage=" + this.totalPage + ", totalCount=" + this.totalCount + ", currentPage=" + this.currentPage + ", categoryId=" + this.categoryId + ", tagName=" + this.tagName + ", albums=" + this.albums + "]";
  }
}

/* Location:           E:\Progs\Dev\Android\Decompile\apktool\zssq\zssq-dex2jar.jar
 * Qualified Name:     com.ximalaya.ting.android.opensdk.model.album.HotAggregation
