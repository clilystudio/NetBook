  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.1.1(this).getType();
    try
    {
      ...
      localCategoryList.setCategories(localList);
      CommonRequest.access$0().postSuccess(this.val$callback, localCategoryList);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.1
