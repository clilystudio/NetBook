  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.24.1(this).getType();
    try
    {
      RankTrackList localRankTrackList = (RankTrackList)localBaseResponse.getResponseBodyStringToObject(localType);
      CommonRequest.access$0().postSuccess(this.val$callback, localRankTrackList);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.24
