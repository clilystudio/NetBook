  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.35.1(this).getType();
    try
    {
      AppModel localAppModel = (AppModel)localBaseResponse.getResponseBodyStringToObject(localType);
      CommonRequest.access$0().postSuccess(this.val$callback, localAppModel);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.35
