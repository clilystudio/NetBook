  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.34.1(this).getType();
    try
    {
      List localList = (List)localBaseResponse.getResponseBodyStringToObject(localType);
      ProgramList localProgramList = new ProgramList();
      localProgramList.setmProgramList(localList);
      CommonRequest.access$0().postSuccess(this.val$callback, localProgramList);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.34
