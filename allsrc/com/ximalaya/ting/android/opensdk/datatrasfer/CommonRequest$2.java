  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.2.1(this).getType();
    try
    {
      List localList = (List)localBaseResponse.getResponseBodyStringToObject(localType);
      UpdateBatchList localUpdateBatchList = new UpdateBatchList();
      localUpdateBatchList.setList(localList);
      CommonRequest.access$0().postSuccess(this.val$callback, localUpdateBatchList);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.2
