  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.20.1(this).getType();
    try
    {
      ColumnList localColumnList = (ColumnList)localBaseResponse.getResponseBodyStringToObject(localType);
      CommonRequest.access$0().postSuccess(this.val$callback, localColumnList);
      return;
    }
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.20
