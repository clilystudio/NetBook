  ...
  implements IHttpCallBack
{
  ...
  public void onResponse(I paramI)
  {
    ...
    Type localType = new CommonRequest.25.1(this).getType();
    try
    {
      List localList = (List)localBaseResponse.getResponseBodyStringToObject(localType);
      RadioList localRadioList = new RadioList();
      localRadioList.setRadios(localList);
 ...
 * Qualified Name:     com.ximalaya.ting.android.opensdk.datatrasfer.CommonRequest.25
