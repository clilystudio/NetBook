  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    if (k != 0)
    {
      ...
      if ((i21 & 0xFFFFFF80) != 0)
        break label272;
      i27 = (byte)(i21 >> 4);
      label141: if ((i23 & 0xFFFFFF80) != 0)
        break label286;
    }
    label258: label272: label286: for (int i28 = (byte)(i23 >> 6); ; i28 = (byte)(0xFC ^ i23 >> 6))
    {
      int i29 = i2 + 1;
    ...
    {
      i7 = (byte)(i3 >> 2);
      label462: if ((i4 & 0xFFFFFF80) != 0)
        break label559;
    }
    label559: for (int i8 = (byte)(i4 >> 4); ; i8 = (byte)(0xF0 ^ i4 >> 4))
    {
      int i9 = i2 + 1;
      arrayOfChar[i2] = b[i7];
      int i10 = i9 + 1;
 ...
 * Qualified Name:     com.alipay.sdk.c.a
