  ...
  implements View.OnClickListener, a, d
{
  ...
  private void B()
  {
    ...
    while (true)
    {
      ...
      label319: i1 = 0;
      continue;
      label324: if (TocReadRecord.get(this.e) != null)
        continue;
      i1 = 0;
    }
    label339: c(0);
    return;
    label345: if ((this.I) && (!this.H))
    {
      D();
      return;
    }
  ...
  private void M()
  {
    ...
    while (true)
    {
      ...
      this.T.a();
      return;
      label74: this.U.setBackgroundResource(2130837611);
    }
  }
  ...
  private void N()
  {
    ...
    if ((localn.e()) || (!w()))
    {
      ...
      while (true)
      {
        ...
        v();
        return;
        label84: this.T.setText(localn.c());
      }
    }
  ...
  {
    return new com.ushaqi.zhuishushenqi.d().a(paramContext, ReaderActivity.class).a("BOOK_ID", paramString1).a("BOOK_TITLE", paramString2).a("TOC_ID", paramString3).a("SOURCE_HOST", paramString4).a("IS_SHOW_TOC", Boolean.valueOf(paramBoolean)).a();
  }
  ...
  {
    return new com.ushaqi.zhuishushenqi.d().a(paramContext, ReaderActivity.class).a("BOOK_ID", paramString1).a("BOOK_TITLE", paramString2).a("TOC_ID", paramString3).a("SOURCE_HOST", null).a("IS_SHOW_TOC", Boolean.valueOf(false)).a("CHAPTERS_KEY", paramHashMap).a("HAS_OTHER_SOURCES", Boolean.valueOf(paramBoolean2)).a();
  }
  ...
  {
    return new com.ushaqi.zhuishushenqi.d().a(paramContext, ReaderActivity.class).a("BOOK_ID", paramString1).a("BOOK_TITLE", paramString2).a("TOC_ID", paramString3).a("SOURCE_HOST", null).a("IS_SHOW_TOC", Boolean.valueOf(false)).a("HAS_OTHER_SOURCES", Boolean.valueOf(paramBoolean2)).a();
  }
  ...
  public final void i()
  {
    ...
    {
      com.ushaqi.zhuishushenqi.util.I.d = str;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      com.ushaqi.zhuishushenqi.util.I.a = this.c;
      com.ushaqi.zhuishushenqi.util.I.b = this.d;
      com.ushaqi.zhuishushenqi.util.I.d = this.f;
      com.ushaqi.zhuishushenqi.util.I.c = this.e;
      com.ushaqi.zhuishushenqi.util.I.g = this.L;
  ...
  public void onResume()
  {
    ...
    K();
    LocalBroadcastManager.getInstance(this).registerReceiver(this.ae, new IntentFilter("com.ushaqi.zhuishushenqi.dlReceiver"));
    H();
 ...
 * Qualified Name:     com.ushaqi.zhuishushenqi.reader.ReaderActivity
