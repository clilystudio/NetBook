...
public final class o
{
  ...
  private void a(View paramView, Advert paramAdvert)
  {
    ...
    while (true)
    {
      ...
      com.ushaqi.zhuishushenqi.util.adutil.n.a(paramAdvert, paramView);
      return;
    ...
    if (paramBoolean)
    {
      ...
      if (am.g())
      {
        ...
        if ((arrayOfChapterLink == null) || (arrayOfChapterLink.length == 0))
        {
          ...
          localCheckBox.setChecked(a.a(this.b, "auto_buy_chapter" + com.ushaqi.zhuishushenqi.util.I.a, false));
  ...
  private static boolean o()
  {
    ...
    do
      return false;
    while (!a.a(MyApplication.a(), "auto_buy_chapter" + com.ushaqi.zhuishushenqi.util.I.a, false));
    return true;
  }
  ...
  private void r()
  {
    ...
    do
    {
      ...
      {
        Advert localAdvert = com.ushaqi.zhuishushenqi.util.adutil.n.b(this.b, "page");
    ...
    while ((!this.e) || (a.a(this.b, "remove_ad_toast_showed" + com.ushaqi.zhuishushenqi.util.I.a, false)) || (!q()) || (!a(localView)) || (am.r(this.b)));
    e.a(this.b, "已为您自动免除广告");
    a.b(this.b, "remove_ad_toast_showed" + com.ushaqi.zhuishushenqi.util.I.a, true);
  }
  ...
  public final void a(n paramn, boolean paramBoolean)
  {
    ...
    if (a(paramn.a()))
    {
      com.umeng.a.b.a(this.b, "paying_page_auto_purchase", com.ushaqi.zhuishushenqi.util.I.b);
  ...
  public final void e()
  {
    ...
    {
      if (this.e)
        com.umeng.a.b.a(this.b, "paying_page_show", com.ushaqi.zhuishushenqi.util.I.b);
      a(true);
      return;
    }
    if (this.p)
  ...
  {
    if (this.e)
      com.umeng.a.b.a(this.b, "paying_page_cancel", com.ushaqi.zhuishushenqi.util.I.b);
  }
  ...
  @l
  public final void onHideAdEvent(com.ushaqi.zhuishushenqi.event.s params)
  {
    s();
  }

  @l
  public final void onLoginEvent(com.ushaqi.zhuishushenqi.event.t paramt)
  {
    if (this.e)
    {
  ...
  @l
  public final void onPayFinish(com.ushaqi.zhuishushenqi.event.y paramy)
  {
    if ((this.e) && (paramy.a()))
    {
  ...
  @l
  public final void onShowThirdAd(com.ushaqi.zhuishushenqi.event.B paramB)
  {
  ...
  @l
  public final void onThemeChanged(com.ushaqi.zhuishushenqi.event.C paramC)
  {
    r();
  }
}
