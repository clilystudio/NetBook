...
public class ReaderRandomActivity extends FragmentActivity
{
  ...
  private com.ushaqi.zhuishushenqi.reader.o[] a = new com.ushaqi.zhuishushenqi.reader.o[3];
  private String b;
  private String c;
  private String d;
  private Reader e;
  private bZ f;
  private bH g;
  private com.ushaqi.zhuishushenqi.reader.K h;
  ...
  {
    return new com.ushaqi.zhuishushenqi.d().a(paramContext, ReaderRandomActivity.class).a("BOOK_ID", paramString1).a("BOOK_TITLE", paramString2).a("TOC_ID", paramString3).a();
  }
  ...
  private void c()
  {
    ...
    com.ushaqi.zhuishushenqi.reader.o localo1 = this.a[0];
    com.ushaqi.zhuishushenqi.reader.o localo2 = this.a[1];
    com.ushaqi.zhuishushenqi.reader.o localo3 = this.a[2];
    n localn2 = localo1.j();
    n localn3 = localo2.j();
    n localn4 = localo3.j();
  ...
  private void e()
  {
    com.ushaqi.zhuishushenqi.reader.o localo = this.a[this.k];
    if (localo == null);
    n localn;
    do
    {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.c = a("BOOK_TITLE");
    this.d = a("TOC_ID");
    com.ushaqi.zhuishushenqi.util.I.g = 0;
    if (paramBundle != null)
 ...
 * Qualified Name:     com.ushaqi.zhuishushenqi.reader.random.ReaderRandomActivity
