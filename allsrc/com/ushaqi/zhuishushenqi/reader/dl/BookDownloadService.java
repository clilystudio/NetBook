...
public class BookDownloadService extends Service
{
  ...
  private com.ushaqi.zhuishushenqi.reader.f k;
  private int l;
  ...
  private static void a(BookDlRecord paramBookDlRecord, int paramInt)
  {
    ...
    i.a().c(new com.ushaqi.zhuishushenqi.event.I());
  }

  private void a(BookReadRecord paramBookReadRecord)
  {
    this.k = new com.ushaqi.zhuishushenqi.reader.f(paramBookReadRecord);
    if (this.c == -1)
    {
  ...
  private void b()
  {
    this.k = new com.ushaqi.zhuishushenqi.reader.f(this.c);
    ...
    if (a.e() <= 10 * this.e << 1)
    {
      com.ushaqi.zhuishushenqi.util.e.a(this, "SD卡剩余容量不足，请减少缓存数目或增加存储");
      stopSelf();
      return;
    }
    a(2);
 ...
 * Qualified Name:     com.ushaqi.zhuishushenqi.reader.dl.BookDownloadService
