...
public class ReaderResourceFragment extends Fragment
{
  ...
  public void onResume()
  {
      ...
      while (true)
        while (true)
          if (localIterator1.hasNext())
          {
            ...
            if ((str2.contains("MIX_TOC_ID")) || (str2.contains("_")))
              continue;
            Iterator localIterator2 = a.j(str1, str2).iterator();
            if (!localIterator2.hasNext())
              continue;
            if ("toc".equals((String)localIterator2.next()))
              break;
            m = 1;
            if (m == 0)
              break label331;
    ...
    while (true)
    {
      ...
      label292: m = 0;
      break label138;
      label297: LinearLayout.LayoutParams localLayoutParams2 = new LinearLayout.LayoutParams(-1, n);
      localLayoutParams2.setMargins(0, i1, 0, 0);
      this.h.setLayoutParams(localLayoutParams2);
      continue;
      label331: this.h.setVisibility(8);
    }
  }
}

/* Location:           E:\Progs\Dev\Android\Decompile\apktool\zssq\zssq-dex2jar.jar
 * Qualified Name:     com.ushaqi.zhuishushenqi.reader.ReaderResourceFragment
