...
public class G extends u
{
  ...
  private void a(Tweet paramTweet, R paramR)
  {
    ...
    while (true)
    {
      ...
      str4 = paramTweet.getUser().getNickname();
      if ((paramTweet.getNames() == null) || (paramTweet.names.length <= 0))
        break label263;
      str5 = "";
      for (int j = 0; (j < 3) && (j < paramTweet.getNames().length); j++)
    ...
    String str4 = str5.substring(0, -2 + str5.length());
    if (paramTweet.getNames().length > 3)
      str4 = str4 + " 等" + paramTweet.getNames().length + "人";
    label263: paramR.l.setText(" " + str4 + " 转发了这条动态");
    ...
    label873: for (int i = 8; ; i = 0)
    {
      ...
      return;
      label753: paramR.l.setVisibility(8);
      paramR.e.setText(t.e(paramTweet.getCreated()));
      break;
 ...
 * Qualified Name:     com.ushaqi.zhuishushenqi.adapter.G
