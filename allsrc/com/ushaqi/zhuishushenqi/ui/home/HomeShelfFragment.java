...
import com.ushaqi.zhuishushenqi.util.adutil.k;
  ...
  implements AbsListView.OnScrollListener
{
  ...
  private void a(List<BookShelf> paramList)
  {
    if ((!paramList.isEmpty()) && (am.q(getActivity())))
    {
      ...
      {
        com.ushaqi.zhuishushenqi.util.c.a().c();
        c(paramList, 4);
      }
    }
  }
  ...
  private void c(List<BookShelf> paramList, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      label17: Advert localAdvert = com.ushaqi.zhuishushenqi.util.c.a().a(str1);
    ...
    while (true)
    {
      ...
      {
        new com.ushaqi.zhuishushenqi.util.adutil.n().a(getActivity(), str1);
        return;
      }
    }
  }
  ...
  @com.squareup.a.l
  public void onAudioBookExitEvent(com.ushaqi.zhuishushenqi.event.b paramb)
  {
    a(false);
    this.l.setVisibility(8);
    this.e.removeFooterView(this.h);
  ...
  @com.squareup.a.l
  public void onBookAdded(com.ushaqi.zhuishushenqi.event.c paramc)
  {
    if (paramc.a())
      k();
  ...
  @com.squareup.a.l
  public void onDownloadProgress(com.ushaqi.zhuishushenqi.event.I paramI)
  {
    if (this.k == 0)
      this.j.notifyDataSetChanged();
  }
  ...
  @com.squareup.a.l
  public void onFeedAdded(com.ushaqi.zhuishushenqi.event.l paraml)
  {
    a(paraml.b(), paraml.a());
  }

  @com.squareup.a.l
  public void onFeedRemoved(com.ushaqi.zhuishushenqi.event.n paramn)
  {
    k();
  ...
  @com.squareup.a.l
  public void onFocusBookEvent(com.ushaqi.zhuishushenqi.event.p paramp)
  {
    if (paramp.a())
    {
  ...
  public void onResume()
  {
    ...
    while (true)
    {
      this.A = false;
      return;
      localAdvert = com.ushaqi.zhuishushenqi.util.c.a().a("top");
  ...
  @com.squareup.a.l
  public void onShelfUpdated(com.ushaqi.zhuishushenqi.event.A paramA)
  {
  ...
  @com.squareup.a.l
  public void onShowThirdAd(com.ushaqi.zhuishushenqi.event.B paramB)
  {
 ...
 * Qualified Name:     com.ushaqi.zhuishushenqi.ui.home.HomeShelfFragment
