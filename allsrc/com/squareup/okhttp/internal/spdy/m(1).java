...
final class m
{
  ...
  private void b()
  {
    for (int i = 0; i < 256; i++)
    {
      ...
      n localn1 = new n(i, k);
      int i3;
      for (n localn2 = this.d; k > 8; localn2 = n.a(localn2)[i3])
      {
        k = (byte)(k - 8);
        i3 = 0xFF & j >>> k;
        if (n.a(localn2) == null)
          throw new IllegalStateException("invalid dictionary: prefix not unique");
        if (n.a(localn2)[i3] != null)
          continue;
        n.a(localn2)[i3] = new n();
      }
      int m = 8 - k;
      int n = 0xFF & j << m;
      int i1 = 1 << m;
      for (int i2 = n; i2 < n + i1; i2++)
        n.a(localn2)[i2] = localn1;
    }
  }
  ...
  final byte[] a(byte[] paramArrayOfByte)
  {
    ...
    while (i < paramArrayOfByte.length)
    {
      ...
      {
        int n = 0xFF & j >>> k - 8;
        localn2 = n.a(localn2)[n];
        if (n.a(localn2) == null)
        {
          localByteArrayOutputStream.write(n.b(localn2));
          k -= n.c(localn2);
          localn2 = this.d;
          continue;
        }
    ...
    {
      int m = 0xFF & j << 8 - k;
      n localn3 = n.a(localn2)[m];
      if ((n.a(localn3) != null) || (n.c(localn3) > k))
        break;
      localByteArrayOutputStream.write(n.b(localn3));
      k -= n.c(localn3);
      localn2 = this.d;
    }
