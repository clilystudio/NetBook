...
public class AccessibilityNodeInfoCompat
{
  ...
  {
    IMPL.addAction(this.mInfo, AccessibilityNodeInfoCompat.AccessibilityActionCompat.access$100(paramAccessibilityActionCompat));
  }
  ...
  public List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList()
  {
    ...
    if (localList != null)
    {
      ...
      int i = localList.size();
      for (int j = 0; j < i; j++)
        ((List)localObject).add(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(localList.get(j), null));
    }
  ...
  {
    IMPL.setCollectionItemInfo(this.mInfo, AccessibilityNodeInfoCompat.CollectionItemInfoCompat.access$300((AccessibilityNodeInfoCompat.CollectionItemInfoCompat)paramObject));
  }
