  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      cn.sharesdk.framework.utils.d.a().w("both musicUrl and musicLowBandUrl are null", new Object[0]);
      return false;
    }
    if ((this.musicUrl != null) && (this.musicUrl.length() > 10240))
    {
      cn.sharesdk.framework.utils.d.a().w("checkArgs fail, musicUrl is too long", new Object[0]);
      return false;
    }
    if ((this.musicLowBandUrl != null) && (this.musicLowBandUrl.length() > 10240))
    {
      cn.sharesdk.framework.utils.d.a().w("checkArgs fail, musicLowBandUrl is too long", new Object[0]);
      return false;
    }
    return true;
  }
