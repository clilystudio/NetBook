  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      cn.sharesdk.framework.utils.d.a().w("checkArgs fail, all arguments is null", new Object[0]);
      return false;
    }
    if ((this.extInfo != null) && (this.extInfo.length() > 2048))
    {
      cn.sharesdk.framework.utils.d.a().w("checkArgs fail, extInfo is invalid", new Object[0]);
      return false;
    }
    if ((this.filePath != null) && (this.filePath.length() > 10240))
    {
      cn.sharesdk.framework.utils.d.a().w("checkArgs fail, filePath is invalid", new Object[0]);
      return false;
    }
